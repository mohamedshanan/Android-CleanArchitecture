...
import com.masary.anamasary.presentation.internal.di.components.DaggerUserComponent;
import com.masary.anamasary.presentation.internal.di.components.UserComponent;
import com.masary.anamasary.presentation.view.fragment.UserDetailsFragment;
...
public class UserDetailsActivity extends BaseActivity implements HasComponent<UserComponent> {
  ...
  private static final String INSTANCE_STATE_PARAM_USER_ID = "org.anamasary.STATE_PARAM_USER_ID";
